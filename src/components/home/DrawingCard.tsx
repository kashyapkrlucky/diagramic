    ...
    >
      ...
      <div className="flex items-start justify-between p-5">
        ...
        <div className="relative">
          ...
          {showMenu && (
            <div className="absolute top-4 right-0 bg-white rounded-lg shadow-lg border border-gray-200">
              <button className="w-full flex items-center gap-2 px-2 py-1 text-left hover:bg-gray-50">
                <Trash2Icon className="w-3 h-3 text-gray-400" />
